...
const baseNavItems = [
  ...
  { id:10, icon: 'oui:nav-overview', label:'Overview', link:'/overview'},
  { id: 3, icon: 'mdi:users', label: 'Users', link: '/users', roles: ['Admin'] },
  { id: 4, icon: 'mdi:cricket', label: 'Players', link: '/players', roles: ['Admin'] },
  { id: 5, icon: 'ri:team-fill', label: 'Teams', link: '/teams',roles: ['Admin'] },
  ...
  { id: 9, icon: 'uil:setting', label: 'Settings', link: '/settings', roles: ['Admin'] },
];
